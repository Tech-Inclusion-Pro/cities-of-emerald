...
// Flag/var defines
#define DN_FLAG_SEARCHING             FLAG_CITIES_DEXNAV_SEARCHING // Searching for mon
#define DN_FLAG_DEXNAV_GET            FLAG_CITIES_DEXNAV_GET // DexNav shows in start menu
#define DN_FLAG_DETECTOR_MODE         FLAG_CITIES_DEXNAV_DETECTOR_MODE // Allow player to find hidden mons
#define DN_VAR_SPECIES                VAR_CITIES_DEXNAV_SPECIES // Registered DexNav species
#define DN_VAR_STEP_COUNTER           VAR_CITIES_DEXNAV_STEP_COUNTER // Steps for finding hidden Pokémon
