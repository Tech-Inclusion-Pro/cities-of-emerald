...
enum StringID
{
    ...
    STRINGID_CITIESWONTLISTENHEAT,     // Cities of Emerald (GDD 6.5)
    STRINGID_CITIESWONTLISTENFEATHER,
    STRINGID_CITIESWONTLISTENMIND,
    STRINGID_CITIESWONTLISTENRAIN,
    STRINGID_CITIESWONTLISTENLATIOS,
    STRINGID_CITIESWONTLISTENLATIAS,
    STRINGID_CITIESNUZLOCKEBLOCK,
    STRINGID_CITIESEXPCAPPED,      // Cities of Emerald: soft cap zeroed the reward (GDD 9.1)
    STRINGID_COUNT
};
