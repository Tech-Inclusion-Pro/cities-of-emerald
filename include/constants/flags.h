...
// Eeveelution trainer mini-story (GDD 4.3, roster approved 2026-09-16)
#define FLAG_CITIES_EEVEE_STONE_WATER_AWARDED       (CITIES_FLAGS_START + 0x9)
#define FLAG_CITIES_EEVEE_STONE_THUNDER_AWARDED     (CITIES_FLAGS_START + 0xA)
#define FLAG_CITIES_EEVEE_STONE_FIRE_AWARDED        (CITIES_FLAGS_START + 0xB)
#define FLAG_CITIES_EEVEE_STONE_LEAF_AWARDED        (CITIES_FLAGS_START + 0xC)
#define FLAG_CITIES_EEVEE_STONE_ICE_AWARDED         (CITIES_FLAGS_START + 0xD)
#define FLAG_CITIES_HIDE_EEVEE_TRAINER_VAPOREON     (CITIES_FLAGS_START + 0xE)
#define FLAG_CITIES_HIDE_EEVEE_TRAINER_JOLTEON      (CITIES_FLAGS_START + 0xF)
#define FLAG_CITIES_HIDE_EEVEE_TRAINER_FLAREON      (CITIES_FLAGS_START + 0x10)
#define FLAG_CITIES_HIDE_EEVEE_TRAINER_ESPEON       (CITIES_FLAGS_START + 0x11)
#define FLAG_CITIES_HIDE_EEVEE_TRAINER_LEAFEON      (CITIES_FLAGS_START + 0x12)
#define FLAG_CITIES_HIDE_EEVEE_TRAINER_SYLVEON      (CITIES_FLAGS_START + 0x13)
#define FLAG_CITIES_HIDE_EEVEE_TRAINER_UMBREON      (CITIES_FLAGS_START + 0x14)
...
// M4 "The Three Lights" (GDD 6.6, outline approved 2026-09-17)
#define FLAG_CITIES_HIDE_M4_KEEPER                  (CITIES_FLAGS_START + 0x37) // Cave of Origin entrance, shown at badge 7
#define FLAG_CITIES_HIDE_M4_UXIE                    (CITIES_FLAGS_START + 0x38) // Chamber statics: hidden once caught
#define FLAG_CITIES_HIDE_M4_MESPRIT                 (CITIES_FLAGS_START + 0x39)
#define FLAG_CITIES_HIDE_M4_AZELF                   (CITIES_FLAGS_START + 0x3A)
...
#define FLAG_CITIES_CORALMERE_OPEN                  (CITIES_FLAGS_START + 0xCB) // Sunken village enterable (set by 12.5 after V2; Task 12.3 gate)
// Team Epoch thread (Task 12.5). Statics follow the H11 pattern: the HIDE flag
// is recomputed on map transition from arc state + the CAUGHT flag.
#define FLAG_CITIES_HIDE_V1_MEWTWO                              (CITIES_FLAGS_START + 0xCC)
#define FLAG_CITIES_HIDE_V1_GENESECT                            (CITIES_FLAGS_START + 0xCD)
#define FLAG_CITIES_HIDE_V1_MEW                                 (CITIES_FLAGS_START + 0xCE)
#define FLAG_CITIES_V1_MEWTWO_CAUGHT                            (CITIES_FLAGS_START + 0xCF)
#define FLAG_CITIES_V1_GENESECT_CAUGHT                          (CITIES_FLAGS_START + 0xD0)
#define FLAG_CITIES_V1_MEW_CAUGHT                               (CITIES_FLAGS_START + 0xD1)
#define FLAG_CITIES_HIDE_V1_EPOCH                               (CITIES_FLAGS_START + 0xD2) // annex grunts + Meridian leave when V1 completes
#define FLAG_CITIES_HIDE_V1_RESEARCHER                          (CITIES_FLAGS_START + 0xD3) // Space Center lobby hook, postgame only
#define FLAG_CITIES_HIDE_V2_TYPE_NULL                           (CITIES_FLAGS_START + 0xD4)
#define FLAG_CITIES_HIDE_V2_SILVALLY                            (CITIES_FLAGS_START + 0xD5)
#define FLAG_CITIES_V2_TYPE_NULL_CAUGHT                         (CITIES_FLAGS_START + 0xD6)
#define FLAG_CITIES_V2_SILVALLY_CAUGHT                          (CITIES_FLAGS_START + 0xD7)
#define FLAG_CITIES_V2_MAGEARNA_GIVEN                           (CITIES_FLAGS_START + 0xD8) // gift: it chooses the player
#define FLAG_CITIES_V2_LETTER_READ                              (CITIES_FLAGS_START + 0xD9) // the Archivist's letter at the camp
#define FLAG_CITIES_HIDE_V2_CAMP                                (CITIES_FLAGS_START + 0xDA) // camp NPCs leave when V2 completes
#define FLAG_CITIES_HIDE_V3_NIHILEGO                            (CITIES_FLAGS_START + 0xDB)
#define FLAG_CITIES_HIDE_V3_BUZZWOLE                            (CITIES_FLAGS_START + 0xDC)
#define FLAG_CITIES_HIDE_V3_PHEROMOSA                           (CITIES_FLAGS_START + 0xDD)
#define FLAG_CITIES_HIDE_V3_XURKITREE                           (CITIES_FLAGS_START + 0xDE)
#define FLAG_CITIES_HIDE_V3_CELESTEELA                          (CITIES_FLAGS_START + 0xDF)
#define FLAG_CITIES_HIDE_V3_KARTANA                             (CITIES_FLAGS_START + 0xE0)
#define FLAG_CITIES_HIDE_V3_GUZZLORD                            (CITIES_FLAGS_START + 0xE1)
#define FLAG_CITIES_HIDE_V3_STAKATAKA                           (CITIES_FLAGS_START + 0xE2)
#define FLAG_CITIES_HIDE_V3_BLACEPHALON                         (CITIES_FLAGS_START + 0xE3)
#define FLAG_CITIES_HIDE_V3_SOLGALEO                            (CITIES_FLAGS_START + 0xE4)
#define FLAG_CITIES_HIDE_V3_LUNALA                              (CITIES_FLAGS_START + 0xE5)
#define FLAG_CITIES_HIDE_V3_NECROZMA                            (CITIES_FLAGS_START + 0xE6)
#define FLAG_CITIES_HIDE_V3_NAGANADEL                           (CITIES_FLAGS_START + 0xE7)
#define FLAG_CITIES_V3_NIHILEGO_CAUGHT                          (CITIES_FLAGS_START + 0xE8)
#define FLAG_CITIES_V3_BUZZWOLE_CAUGHT                          (CITIES_FLAGS_START + 0xE9)
#define FLAG_CITIES_V3_PHEROMOSA_CAUGHT                         (CITIES_FLAGS_START + 0xEA)
#define FLAG_CITIES_V3_XURKITREE_CAUGHT                         (CITIES_FLAGS_START + 0xEB)
#define FLAG_CITIES_V3_CELESTEELA_CAUGHT                        (CITIES_FLAGS_START + 0xEC)
#define FLAG_CITIES_V3_KARTANA_CAUGHT                           (CITIES_FLAGS_START + 0xED)
#define FLAG_CITIES_V3_GUZZLORD_CAUGHT                          (CITIES_FLAGS_START + 0xEE)
#define FLAG_CITIES_V3_STAKATAKA_CAUGHT                         (CITIES_FLAGS_START + 0xEF)
#define FLAG_CITIES_V3_BLACEPHALON_CAUGHT                       (CITIES_FLAGS_START + 0xF0)
#define FLAG_CITIES_V3_SOLGALEO_CAUGHT                          (CITIES_FLAGS_START + 0xF1)
#define FLAG_CITIES_V3_LUNALA_CAUGHT                            (CITIES_FLAGS_START + 0xF2)
#define FLAG_CITIES_V3_NECROZMA_CAUGHT                          (CITIES_FLAGS_START + 0xF3)
#define FLAG_CITIES_V3_NAGANADEL_CAUGHT                         (CITIES_FLAGS_START + 0xF4)
#define FLAG_CITIES_V3_COSMOG_GIVEN                             (CITIES_FLAGS_START + 0xF5) // gift: shelters with the player
#define FLAG_CITIES_V3_POIPOLE_GIVEN                            (CITIES_FLAGS_START + 0xF6) // gift: a grunt's thank-you
#define FLAG_CITIES_V3_REWARD_GIVEN                             (CITIES_FLAGS_START + 0xF7) // N-Solarizer + N-Lunarizer from Gnomon
#define FLAG_CITIES_HIDE_V3_HELPERS                             (CITIES_FLAGS_START + 0xF8) // grunt helpers at wormhole sites, V3 only
#define FLAG_CITIES_HIDE_V3_ARCHIVIST                           (CITIES_FLAGS_START + 0xF9) // his in-person scene at the final wormhole
#define FLAG_CITIES_HIDE_V4_KORAIDON                            (CITIES_FLAGS_START + 0xFA)
#define FLAG_CITIES_HIDE_V4_MIRAIDON                            (CITIES_FLAGS_START + 0xFB)
#define FLAG_CITIES_HIDE_V4_TERAPAGOS                           (CITIES_FLAGS_START + 0xFC)
#define FLAG_CITIES_HIDE_V4_GREAT_TUSK                          (CITIES_FLAGS_START + 0xFD)
#define FLAG_CITIES_HIDE_V4_SCREAM_TAIL                         (CITIES_FLAGS_START + 0xFE)
#define FLAG_CITIES_HIDE_V4_BRUTE_BONNET                        (CITIES_FLAGS_START + 0xFF)
#define FLAG_CITIES_HIDE_V4_FLUTTER_MANE                        (CITIES_FLAGS_START + 0x100)
#define FLAG_CITIES_HIDE_V4_SLITHER_WING                        (CITIES_FLAGS_START + 0x101)
#define FLAG_CITIES_HIDE_V4_SANDY_SHOCKS                        (CITIES_FLAGS_START + 0x102)
#define FLAG_CITIES_HIDE_V4_ROARING_MOON                        (CITIES_FLAGS_START + 0x103)
#define FLAG_CITIES_HIDE_V4_WALKING_WAKE                        (CITIES_FLAGS_START + 0x104)
#define FLAG_CITIES_HIDE_V4_GOUGING_FIRE                        (CITIES_FLAGS_START + 0x105)
#define FLAG_CITIES_HIDE_V4_RAGING_BOLT                         (CITIES_FLAGS_START + 0x106)
#define FLAG_CITIES_HIDE_V4_IRON_TREADS                         (CITIES_FLAGS_START + 0x107)
#define FLAG_CITIES_HIDE_V4_IRON_BUNDLE                         (CITIES_FLAGS_START + 0x108)
#define FLAG_CITIES_HIDE_V4_IRON_HANDS                          (CITIES_FLAGS_START + 0x109)
#define FLAG_CITIES_HIDE_V4_IRON_JUGULIS                        (CITIES_FLAGS_START + 0x10A)
#define FLAG_CITIES_HIDE_V4_IRON_MOTH                           (CITIES_FLAGS_START + 0x10B)
#define FLAG_CITIES_HIDE_V4_IRON_THORNS                         (CITIES_FLAGS_START + 0x10C)
#define FLAG_CITIES_HIDE_V4_IRON_VALIANT                        (CITIES_FLAGS_START + 0x10D)
#define FLAG_CITIES_HIDE_V4_IRON_LEAVES                         (CITIES_FLAGS_START + 0x10E)
#define FLAG_CITIES_HIDE_V4_IRON_BOULDER                        (CITIES_FLAGS_START + 0x10F)
#define FLAG_CITIES_HIDE_V4_IRON_CROWN                          (CITIES_FLAGS_START + 0x110)
#define FLAG_CITIES_V4_KORAIDON_CAUGHT                          (CITIES_FLAGS_START + 0x111)
#define FLAG_CITIES_V4_MIRAIDON_CAUGHT                          (CITIES_FLAGS_START + 0x112)
#define FLAG_CITIES_V4_TERAPAGOS_CAUGHT                         (CITIES_FLAGS_START + 0x113)
#define FLAG_CITIES_V4_GREAT_TUSK_CAUGHT                        (CITIES_FLAGS_START + 0x114)
#define FLAG_CITIES_V4_SCREAM_TAIL_CAUGHT                       (CITIES_FLAGS_START + 0x115)
#define FLAG_CITIES_V4_BRUTE_BONNET_CAUGHT                      (CITIES_FLAGS_START + 0x116)
#define FLAG_CITIES_V4_FLUTTER_MANE_CAUGHT                      (CITIES_FLAGS_START + 0x117)
#define FLAG_CITIES_V4_SLITHER_WING_CAUGHT                      (CITIES_FLAGS_START + 0x118)
#define FLAG_CITIES_V4_SANDY_SHOCKS_CAUGHT                      (CITIES_FLAGS_START + 0x119)
#define FLAG_CITIES_V4_ROARING_MOON_CAUGHT                      (CITIES_FLAGS_START + 0x11A)
#define FLAG_CITIES_V4_WALKING_WAKE_CAUGHT                      (CITIES_FLAGS_START + 0x11B)
#define FLAG_CITIES_V4_GOUGING_FIRE_CAUGHT                      (CITIES_FLAGS_START + 0x11C)
#define FLAG_CITIES_V4_RAGING_BOLT_CAUGHT                       (CITIES_FLAGS_START + 0x11D)
#define FLAG_CITIES_V4_IRON_TREADS_CAUGHT                       (CITIES_FLAGS_START + 0x11E)
#define FLAG_CITIES_V4_IRON_BUNDLE_CAUGHT                       (CITIES_FLAGS_START + 0x11F)
#define FLAG_CITIES_V4_IRON_HANDS_CAUGHT                        (CITIES_FLAGS_START + 0x120)
#define FLAG_CITIES_V4_IRON_JUGULIS_CAUGHT                      (CITIES_FLAGS_START + 0x121)
#define FLAG_CITIES_V4_IRON_MOTH_CAUGHT                         (CITIES_FLAGS_START + 0x122)
#define FLAG_CITIES_V4_IRON_THORNS_CAUGHT                       (CITIES_FLAGS_START + 0x123)
#define FLAG_CITIES_V4_IRON_VALIANT_CAUGHT                      (CITIES_FLAGS_START + 0x124)
#define FLAG_CITIES_V4_IRON_LEAVES_CAUGHT                       (CITIES_FLAGS_START + 0x125)
#define FLAG_CITIES_V4_IRON_BOULDER_CAUGHT                      (CITIES_FLAGS_START + 0x126)
#define FLAG_CITIES_V4_IRON_CROWN_CAUGHT                        (CITIES_FLAGS_START + 0x127)
#define FLAG_CITIES_HIDE_V4_MERIDIAN                            (CITIES_FLAGS_START + 0x128) // Route 128 rift anchors
#define FLAG_CITIES_HIDE_V4_GNOMON                              (CITIES_FLAGS_START + 0x129) // New Mauville pocket
#define FLAG_CITIES_HIDE_V5_ETERNATUS                           (CITIES_FLAGS_START + 0x12A)
...
#define FLAG_CITIES_SURVIVOR_DEWFORD                            (CITIES_FLAGS_START + 0x134) // Coralmere survivors met (Task 12.7)
#define FLAG_CITIES_SURVIVOR_SLATEPORT                          (CITIES_FLAGS_START + 0x135)
#define FLAG_CITIES_SURVIVOR_MAUVILLE                           (CITIES_FLAGS_START + 0x136)
#define FLAG_CITIES_SURVIVOR_FALLARBOR                          (CITIES_FLAGS_START + 0x137)
#define FLAG_CITIES_SURVIVOR_LILYCOVE                           (CITIES_FLAGS_START + 0x138)
#define FLAG_CITIES_SURVIVOR_MOSSDEEP                           (CITIES_FLAGS_START + 0x139)
#define FLAG_CITIES_SURVIVOR_SOOTOPOLIS                         (CITIES_FLAGS_START + 0x13A)
#define FLAG_CITIES_SURVIVOR_PACIFIDLOG                         (CITIES_FLAGS_START + 0x13B) // the family (set by the naming scene)
// Mythical events (Task 13.1). All fixed L70, postgame.
#define FLAG_CITIES_MYTHIC_JIRACHI_CAUGHT                      (CITIES_FLAGS_START + 0x13C)
#define FLAG_CITIES_MYTHIC_DIANCIE_CAUGHT                      (CITIES_FLAGS_START + 0x13D)
#define FLAG_CITIES_MYTHIC_MANAPHY_CAUGHT                      (CITIES_FLAGS_START + 0x13E)
#define FLAG_CITIES_MYTHIC_PHIONE_CAUGHT                       (CITIES_FLAGS_START + 0x13F)
#define FLAG_CITIES_MYTHIC_VICTINI_CAUGHT                      (CITIES_FLAGS_START + 0x140)
#define FLAG_CITIES_MYTHIC_MELOETTA_CAUGHT                     (CITIES_FLAGS_START + 0x141)
#define FLAG_CITIES_MYTHIC_VOLCANION_CAUGHT                    (CITIES_FLAGS_START + 0x142)
#define FLAG_CITIES_MYTHIC_MARSHADOW_CAUGHT                    (CITIES_FLAGS_START + 0x143)
#define FLAG_CITIES_MYTHIC_ZERAORA_CAUGHT                      (CITIES_FLAGS_START + 0x144)
#define FLAG_CITIES_MYTHIC_ZARUDE_CAUGHT                       (CITIES_FLAGS_START + 0x145)
#define FLAG_CITIES_MYTHIC_SHAYMIN_CAUGHT                      (CITIES_FLAGS_START + 0x146)
#define FLAG_CITIES_MYTHIC_HOOPA_CAUGHT                        (CITIES_FLAGS_START + 0x147)
#define FLAG_CITIES_MYTHIC_MELTAN_CAUGHT                       (CITIES_FLAGS_START + 0x148)
#define FLAG_CITIES_MYTHIC_MELMETAL_CAUGHT                     (CITIES_FLAGS_START + 0x149)
#define FLAG_CITIES_HIDE_MYTHIC_JIRACHI                        (CITIES_FLAGS_START + 0x14A)
#define FLAG_CITIES_HIDE_MYTHIC_DIANCIE                        (CITIES_FLAGS_START + 0x14B)
#define FLAG_CITIES_HIDE_MYTHIC_MANAPHY                        (CITIES_FLAGS_START + 0x14C)
#define FLAG_CITIES_HIDE_MYTHIC_PHIONE                         (CITIES_FLAGS_START + 0x14D)
#define FLAG_CITIES_HIDE_MYTHIC_VICTINI                        (CITIES_FLAGS_START + 0x14E)
#define FLAG_CITIES_HIDE_MYTHIC_MELOETTA                       (CITIES_FLAGS_START + 0x14F)
#define FLAG_CITIES_HIDE_MYTHIC_VOLCANION                      (CITIES_FLAGS_START + 0x150)
#define FLAG_CITIES_HIDE_MYTHIC_MARSHADOW                      (CITIES_FLAGS_START + 0x151)
#define FLAG_CITIES_HIDE_MYTHIC_ZERAORA                        (CITIES_FLAGS_START + 0x152)
#define FLAG_CITIES_HIDE_MYTHIC_ZARUDE                         (CITIES_FLAGS_START + 0x153)
#define FLAG_CITIES_HIDE_MYTHIC_SHAYMIN                        (CITIES_FLAGS_START + 0x154)
#define FLAG_CITIES_HIDE_MYTHIC_HOOPA                          (CITIES_FLAGS_START + 0x155)
#define FLAG_CITIES_HIDE_MYTHIC_MELTAN                         (CITIES_FLAGS_START + 0x156)
#define FLAG_CITIES_HIDE_MYTHIC_MELMETAL                       (CITIES_FLAGS_START + 0x157)
#define FLAG_CITIES_MYTHIC_DEOXYS_SAILOR                       (CITIES_FLAGS_START + 0x158) // Lilycove sailor to Birth Island (postgame)
#define FLAG_CITIES_MYTHIC_SHAYMIN_MEADOW                      (CITIES_FLAGS_START + 0x159) // Route 119 meadow revealed by Halley
#define FLAG_CITIES_MYTHIC_HOOPA_RING                          (CITIES_FLAGS_START + 0x15A) // the ring in the Trick House entrance (postgame)
#define FLAG_CITIES_HIDE_MYTHIC_HOOPA_PRIZE                    (CITIES_FLAGS_START + 0x15B) // Prison Bottle item ball in the Ring Chamber
#define FLAG_CITIES_MYTHIC_MELTAN_NUT_1                        (CITIES_FLAGS_START + 0x15C)
#define FLAG_CITIES_MYTHIC_MELTAN_NUT_2                        (CITIES_FLAGS_START + 0x15D)
#define FLAG_CITIES_MYTHIC_MELTAN_NUT_3                        (CITIES_FLAGS_START + 0x15E)
#define FLAG_CITIES_MYTHIC_MELTAN_NUT_4                        (CITIES_FLAGS_START + 0x15F)
